    ...
    >
      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          <h3 className="text-lg font-bold text-[var(--text-primary)] group-hover:text-[var(--accent-primary)] transition-colors">{asset.name}</h3>
        ...
        <div className="pt-4 border-t border-[var(--border-light)] grid grid-cols-2 gap-2">
          <div>
            <p className="text-xs text-[var(--text-muted)] mb-1">{t('assets.currentValue')}</p>
            <p className="font-semibold text-[var(--text-primary)]">{formatCurrency(asset.current_value)}</p>
          </div>
        ...
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 bg-[var(--bg-secondary)] border border-[var(--border-light)] rounded-lg text-[var(--text-primary)] focus:outline-none focus:border-[var(--accent-primary)] transition-colors w-full md:w-64"
            />
          </div>
      ...
      {loading ? (
        ...
        <div className="glass-panel p-12 flex flex-col items-center justify-center text-center min-h-[400px]">
          ...
          <p className="text-[var(--text-secondary)] mb-6">
            {search ? t('assets.tryOtherSearch') : t('assets.addFirstAsset')}
          </p>
